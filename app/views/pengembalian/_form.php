        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="jaminan" name="jaminan" required readonly>
                </div>
                <div class="form-group">
                    <label for="tgl_mulai">Tgl. Mulai</label>
                    <div class="input-group">
                        <input type="text" class="form-control" id="tgl_mulai" placeholder="Tgl. Mulai" required readonly disabled>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="tgl_akhir" placeholder="Tgl. Akhir" required readonly disabled>
                        <div class="input-group-addon">
                            <span class="glyphicon glyphicon-th"></span>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="tgl_kembali" placeholder="Tgl. Kembali" required>
                        <div class="input-group-addon">
                            <span class="glyphicon glyphicon-th"></span>
                        </div>
                    </div>
        ...
        <div class="panel panel-warning">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="inventaris" name="inventaris" required readonly>
                </div>
                <div class="form-group">
                    <label for="hrg_sewa">Harga Sewa</label>
                    <input type="text" class="form-control" id="hrg_sewa" name="hrg_sewa" required readonly>
                </div>
                <div class="form-group">
                    <label for="no_polisi">No. Polisi</label>
                    <input type="text" class="form-control" id="no_polisi" name="no_polisi" required readonly>
                </div>
                <div class="form-group">
                    <label for="no_mesin">No. Mesin</label>
                    <input type="text" class="form-control" id="no_mesin" name="no_mesin" required readonly>
                </div>
            </div>
        </div>
