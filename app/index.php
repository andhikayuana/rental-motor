...
//my custom for template layout ::Yuana
//header
define('TPL_HEADER', APP.'views/layouts/header.php');
//nav
define('TPL_NAV', APP.'views/layouts/nav.php');
//footer
define('TPL_FOOTER', APP.'views/layouts/footer.php');
